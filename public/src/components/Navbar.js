      ...
      <header data-thq="thq-navbar" className="home-navbar">
        <div className="home-left1">
          ...
          <nav className="home-links1">
            <Link to="/department" className="home-link10">
              Departments
            </Link>
            <a
            ...
            <Link to="/how-it-works" className="home-link12">
              How it works
            </Link>
            <Link to="/about" className="home-link13">
              About
            </Link>
            <Link to="/contact" className="home-link14">
              Contact
            </Link>
          </nav>
        </div>
        <div className="home-right1">
          <button className="home-phone button">
            <img alt="image" src="/Icons/phone.svg" className="home-image16" />
